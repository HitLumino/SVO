...
int main(int argc, char **argv)
{
  ...
  //std::string img_name(svo::test_utils::getDatasetDir() + "/mav0/cam0/data/1403636579763555584.png");
  std::string img_name("/home/lumino/Downloads/mav0/cam0/data/1403636579763555584.png");
